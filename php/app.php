...
class App
{
    ...
    // SELECT
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // $row = $app->select('users', $id);
    ////////////////////////////////////////////////////////////////////////////////////////////////

    public function select($table='', $id=0) {
        $sql = "
            SELECT *
            FROM {$table}
            WHERE id = ?
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // $params = ['name' => 'Alex'];
    // $lastInsertId = $app->insert('users', $params);
    ////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function insert($table='', $params=[]) {
        ...
        $sql = "
            ...
            SET {$fields}
        ";
        $lastInsertId = $this->query($sql, $params);
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // $params = ['name' => 'Alex'];
    // $rowCount = $app->update('users', $params, $id);
    ////////////////////////////////////////////////////////////////////////////////////////////////

    public function update($table='', $params=[], $id=0) {
        $fields = [];
        foreach ($params as $k=>$v) {
            $fields[] = "`" . $k . "`=:" . $k;
        }
        ...
        $sql = "
            ...
            WHERE id = :id
        ";
        $rowCount = $this->query($sql, $params);
